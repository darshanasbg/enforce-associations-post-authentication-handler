...
package org.wso2.carbon.identity.post.authn.handler.association.enforcer;
...
public class AssociationEnforcerPostAuthenticationHandler extends PostAuthAssociationHandler {

    private static final Log log = LogFactory.getLog(AssociationEnforcerPostAuthenticationHandler.class);
    private static AssociationEnforcerPostAuthenticationHandler instance =
            new AssociationEnforcerPostAuthenticationHandler();
    private static final String USER_TENANT_DOMAIN = "user-tenant-domain";

    /**
     * To get an instance of {@link AssociationEnforcerPostAuthenticationHandler}.
     *
     * @return instance of AssociationEnforcerPostAuthenticationHandler
     */
    public static AssociationEnforcerPostAuthenticationHandler getInstance() {
        return instance;
    }
     ...
     */
    protected AssociationEnforcerPostAuthenticationHandler() { }

    @Override
    public String getName() {

        return "AssociationEnforcerPostAuthenticationHandler";
    }
